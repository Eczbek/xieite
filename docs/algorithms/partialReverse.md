...
constexpr void partialReverse(Iterator begin, Iterator end, const xieite::concepts::CallbackSelector<typename std::iterator_traits<Iterator>::value_type> auto& selector) noexcept;
```
### Template parameters
