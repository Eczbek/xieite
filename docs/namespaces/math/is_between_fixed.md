...
[[nodiscard]] constexpr bool isBetweenFixed(Arithmetic value, std::type_identity_t<Arithmetic> limit1, std::type_identity_t<Arithmetic> limit2, bool floorInclusive = true, bool ceilingInclusive = true) noexcept;
```
