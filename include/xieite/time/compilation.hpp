...
namespace xieite::time::compilation {
	...
	static constexpr int months = (xieite::containers::FixedMap<std::string_view, int, 12> { { "Jan", 1 }, { "Feb", 2 }, { "Mar", 3 }, { "Apr", 4 }, { "May", 5 }, { "Jun", 6 }, { "Jul", 7 }, { "Aug", 8 }, { "Sep", 9 }, { "Oct", 10 }, { "Nov", 11 }, { "Dec", 12 } })[std::string_view(__DATE__).substr(0, 3)].value();
