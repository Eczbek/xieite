...
#		define XIEITE_ATTRIBUTES_STANDARD_CALL __attribute__((__stdcall__))
#	elif XIEITE_COMPILER_TYPE_CLANG
#		define XIEITE_ATTRIBUTES_STANDARD_CALL __stdcall
#	elif XIEITE_COMPILER_TYPE_MSVC
#		define XIEITE_ATTRIBUTES_STANDARD_CALL __cdecl
#	else
#		define XIEITE_ATTRIBUTES_STANDARD_CALL
#	endif
