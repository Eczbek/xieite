...
#	define XIEITE_COMPILER_VERSION_LEAST(...) XIEITE_INTERNAL_COMPILER_VERSION_CHECK_OVERLOAD(__VA_ARGS__, XIEITE_INTERNAL_COMPILER_VERSION_CHECK_LEAST(__VA_ARGS__), XIEITE_INTERNAL_COMPILER_VERSION_CHECK_LEAST(__VA_ARGS__, 0), XIEITE_INTERNAL_COMPILER_VERSION_CHECK_LEAST(__VA_ARGS__, 0, 0))
#	define XIEITE_COMPILER_VERSION_MOST(...) XIEITE_INTERNAL_COMPILER_VERSION_CHECK_OVERLOAD(__VA_ARGS__, XIEITE_INTERNAL_COMPILER_VERSION_CHECK_MOST(__VA_ARGS__), XIEITE_INTERNAL_COMPILER_VERSION_CHECK_MOST(__VA_ARGS__, 0), XIEITE_INTERNAL_COMPILER_VERSION_CHECK_MOST(__VA_ARGS__, 0, 0))
#	define XIEITE_INTERNAL_COMPILER_VERSION_CHECK_OVERLOAD(_1, _2, _3, overload, ...) overload
#	define XIEITE_INTERNAL_COMPILER_VERSION_CHECK_LEAST(major, minor, patch) ((XIEITE_COMPILER_VERSION_MAJOR > (major)) || (XIEITE_COMPILER_VERSION_MAJOR == (major)) && ((XIEITE_COMPILER_VERSION_MINOR > (minor) || (XIEITE_COMPILER_VERSION_MINOR == (minor)) && (XIEITE_COMPILER_VERSION_PATCH >= (patch)))))
#	define XIEITE_INTERNAL_COMPILER_VERSION_CHECK_MOST(major, minor, patch) ((XIEITE_COMPILER_VERSION_MAJOR < (major)) || (XIEITE_COMPILER_VERSION_MAJOR == (major)) && ((XIEITE_COMPILER_VERSION_MINOR < (minor) || (XIEITE_COMPILER_VERSION_MINOR == (minor)) && (XIEITE_COMPILER_VERSION_PATCH <= (patch)))))
...
#	if XIEITE_COMPILER_TYPE_ALTIUM_C_TO_HARDWARE || XIEITE_COMPILER_TYPE_MICROBLAZE
#		undef XIEITE_COMPILER_VERSION_MAJOR
