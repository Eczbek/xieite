...
namespace xieite::geometry {
	[[nodiscard]] constexpr xieite::geometry::Point scale(
		const xieite::geometry::Point point,
		const double scale,
		const xieite::geometry::Point origin = xieite::geometry::Point(0, 0)
	) noexcept {
	...
	> [[nodiscard]] constexpr LinearShape scale(
	...
	[[nodiscard]] constexpr xieite::geometry::Polygon scale(
