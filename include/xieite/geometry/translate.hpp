...
namespace xieite::geometry {
	[[nodiscard]] constexpr xieite::geometry::Point translate(
		const xieite::geometry::Point point,
		const xieite::geometry::Point difference
	) noexcept {
	...
	> [[nodiscard]] constexpr LinearShape translate(
	...
	[[nodiscard]] constexpr xieite::geometry::Polygon translate(
