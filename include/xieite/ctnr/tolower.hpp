#ifndef DETAIL_XIEITE_HEADER_CTNR_TOLOWER
#	define DETAIL_XIEITE_HEADER_CTNR_TOLOWER
#
#	include <array>
#	include <cstddef>
#	include <memory>
...
namespace xieite {
	...
	[[nodiscard]] constexpr auto tolower(const xieite::paren<Ch[n]>& str, Alloc&& alloc = {})
