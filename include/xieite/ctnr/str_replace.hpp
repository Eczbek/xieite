#ifndef DETAIL_XIEITE_HEADER_CTNR_STR_REPLACE
#	define DETAIL_XIEITE_HEADER_CTNR_STR_REPLACE
#
#	include <cstddef>
#	include <memory>
#	include <string>
...
namespace xieite {
	...
	[[nodiscard]] constexpr auto str_replace(const xieite::paren<Ch[n]>& str, auto&& orig, auto&& with, Alloc&& alloc = {})
