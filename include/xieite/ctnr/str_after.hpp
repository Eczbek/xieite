#ifndef DETAIL_XIEITE_HEADER_CTNR_STR_AFTER
#	define DETAIL_XIEITE_HEADER_CTNR_STR_AFTER
#
#	include <cstddef>
#	include <string>
#	include <string_view>
...
namespace xieite {
	...
	[[nodiscard]] constexpr auto str_after(const xieite::paren<Ch[n]>& str, auto&& delim)
