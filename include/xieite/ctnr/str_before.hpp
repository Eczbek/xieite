#ifndef DETAIL_XIEITE_HEADER_CTNR_STR_BEFORE
#	define DETAIL_XIEITE_HEADER_CTNR_STR_BEFORE
#
#	include <cstddef>
#	include <string>
#	include <string_view>
...
namespace xieite {
	...
	[[nodiscard]] constexpr auto str_before(const xieite::paren<Ch[n]>& str, auto&& delim)
