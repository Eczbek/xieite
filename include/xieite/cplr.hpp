...
#	undef XIEITE_CPLR_MAJOR_NVIDIA_HPC
#	define XIEITE_CPLR_MAJOR_NVIDIA_HPC __NVCOMPILER_MAJOR__

#	undef XIEITE_CPLR_MINOR_NVIDIA_HPC
#	define XIEITE_CPLR_MINOR_NVIDIA_HPC __NVCOMPILER_MINOR__
#endif
