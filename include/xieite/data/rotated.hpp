...
namespace xieite {
	template<std::ranges::input_range Range0, std::ranges::input_range Range1, xieite::is_invoc<bool(std::ranges::range_common_reference_t<Range0>, std::ranges::range_common_reference_t<Range1>)> Fn = std::ranges::equal_to>
