...
namespace xieite {
	template<xieite::is_fwd_input_sized_range Range, xieite::is_invoc<bool(std::ranges::range_common_reference_t<Range>, std::ranges::range_common_reference_t<Range>)> Fn = std::equal_to<>>
