...
namespace xieite {
	...
	[[nodiscard]] constexpr std::basic_string<Char, Traits, Alloc> pad_back(const xieite::paren<Char[length]>& str, std::size_t target_length, Char c = ' ', const Alloc& alloc = {}) noexcept(false) {
