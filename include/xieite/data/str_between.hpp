...
namespace xieite {
	...
	[[nodiscard]] constexpr auto str_between(const std::basic_string<Char, Traits>& str, auto&& a, auto&& b)
		XIEITE_ARROW(xieite::str_between(xieite::make_str_view(str), XIEITE_FWD(a), XIEITE_FWD(b)))
	...
	[[nodiscard]] constexpr auto str_between(const xieite::paren<Char[length]>& str, auto&& a, auto&& b)
		XIEITE_ARROW(xieite::str_between(xieite::make_str_view<Char, Traits>(str), XIEITE_FWD(a), XIEITE_FWD(b)))
}
