...
namespace xieite {
	...
	[[nodiscard]] constexpr std::basic_string_view<Char, Traits> substr(const std::basic_string<Char, Traits, Alloc>& str, std::size_t start, std::size_t end = std::string_view::npos, std::size_t start_offset = 0, std::size_t end_offset = 0) noexcept {
