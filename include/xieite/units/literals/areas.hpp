...
namespace xieite::units::literals {
	[[nodiscard]] constexpr double operator""_squareNanometers(
	...
	[[nodiscard]] constexpr double operator""_squareMicrometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareMillimeters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareCentimeters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareDecimeters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareMeters(
		const long double value
	) noexcept {
		return value;
	}
	...
	[[nodiscard]] constexpr double operator""_squareDecameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareHectometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareKilometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareMegameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareGigameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareThous(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareBarleycorns(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareInches(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareFeet(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareYards(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareChains(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareFurlongs(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareMiles(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareLeagues(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareFathoms(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareCables(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareNauticalMiles(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareLinks(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_squareRods(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_perches(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_roods(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_acres(
		const long double value
	) noexcept {
