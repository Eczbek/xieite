...
namespace xieite::units::literals {
	[[nodiscard]] constexpr double operator""_attolitres(
	...
	[[nodiscard]] constexpr double operator""_femtolitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_picolitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_nanolitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_microlitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_millilitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_centilitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_decilitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_litres(
		const long double value
	) noexcept {
		return value;
	}
	...
	[[nodiscard]] constexpr double operator""_decalitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_hectolitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_kilolitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_megalitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_gigalitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_teralitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_petalitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_exalitres(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_fluidOunces(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_pints(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_quarts(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_gallons(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_gills(
		const long double value
	) noexcept {
