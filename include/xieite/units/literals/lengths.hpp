...
namespace xieite::units::literals {
	[[nodiscard]] constexpr double operator""_attometers(
	...
	[[nodiscard]] constexpr double operator""_femtometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_picometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_nanometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_micrometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_millimeters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_centimeters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_decimeters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_meters(
		const long double value
	) noexcept {
		return value;
	}
	...
	[[nodiscard]] constexpr double operator""_decameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_hectometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_kilometers(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_megameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_gigameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_terameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_petameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_exameters(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_twips(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_thous(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_barleycorns(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_inches(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_feet(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_yards(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_chains(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_furlongs(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_miles(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_leagues(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_fathoms(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_cables(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_nauticalMiles(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_links(
		const long double value
	) noexcept {
	...
	[[nodiscard]] constexpr double operator""_rods(
		const long double value
	) noexcept {
