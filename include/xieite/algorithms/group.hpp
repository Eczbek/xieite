...
namespace xieite::algorithms {
	...
	noexcept(xieite::concepts::NoThrowInvocable<Functor, std::ranges::range_reference_t<Range>>) {
		return xieite::algorithms::group(range, [&callback](const std::ranges::range_const_reference_t<Range> value, std::size_t) -> std::invoke_result_t<Functor, std::ranges::range_reference_t<Range>> {
