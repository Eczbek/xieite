...
namespace xieite::algorithms {
	...
	[[nodiscard]] constexpr std::ranges::subrange<std::ranges::iterator_t<Range>> findMostConsecutive(Range&& range, const std::ranges::range_const_reference_t<Range> value, Comparator&& comparator = Comparator()) noexcept {
