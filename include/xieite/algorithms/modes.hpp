...
namespace xieite::algorithms {
	...
	[[nodiscard]] constexpr std::vector<std::ranges::const_iterator_t<const Range&>> modes(const Range& range, const GreaterComparator greaterComparator = GreaterComparator()) noexcept {
