...
namespace DETAIL_XIEITE::rm_rref_referent {
	...
	struct impl : decltype(xieite::visitor(
		...
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) noexcept(noex)>) { return xieite::type<Ret(Args...) & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) const noexcept(noex)>) { return xieite::type<Ret(Args...) const & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) volatile noexcept(noex)>) { return xieite::type<Ret(Args...) volatile & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) const volatile noexcept(noex)>) { return xieite::type<Ret(Args...) const volatile & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) && noexcept(noex)>) { return xieite::type<Ret(Args...) noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) const && noexcept(noex)>) { return xieite::type<Ret(Args...) const noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) volatile && noexcept(noex)>) { return xieite::type<Ret(Args...) volatile noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(xieite::type<Ret(Args...) const volatile && noexcept(noex)>) { return xieite::type<Ret(Args...) const volatile noexcept(noex)>(); },
