...
namespace DETAIL_XIEITE::rm_rref_referent {
	...
	struct impl : decltype(xieite::visitor(
		...
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) noexcept(noex)>) { return std::type_identity<Ret(Args...) & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) const noexcept(noex)>) { return std::type_identity<Ret(Args...) const & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) volatile noexcept(noex)>) { return std::type_identity<Ret(Args...) volatile & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) const volatile noexcept(noex)>) { return std::type_identity<Ret(Args...) const volatile & noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) && noexcept(noex)>) { return std::type_identity<Ret(Args...) noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) const && noexcept(noex)>) { return std::type_identity<Ret(Args...) const noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) volatile && noexcept(noex)>) { return std::type_identity<Ret(Args...) volatile noexcept(noex)>(); },
		[]<typename Ret, typename S, typename... Args, bool noex>(std::type_identity<Ret(Args...) const volatile && noexcept(noex)>) { return std::type_identity<Ret(Args...) const volatile noexcept(noex)>(); },
...
namespace xieite {
	template<typename T>
	using rm_rref_referent = xieite::cp_cvref<T, typename DETAIL_XIEITE::rm_rref_referent::impl<T>::type>;
}
