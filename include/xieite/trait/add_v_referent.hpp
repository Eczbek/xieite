...
namespace DETAIL_XIEITE::add_v_referent {
	...
	struct impl<Ret(Args...) noexcept(noex)> : xieite::type<Ret(Args...) volatile noexcept(noex)> {};

	template<typename Ret, typename... Args, bool noex>
	struct impl<Ret(Args...) const noexcept(noex)> : xieite::type<Ret(Args...) const volatile noexcept(noex)> {};
	...
	struct impl<Ret(S::*)(Args...) noexcept(noex)> : xieite::type<Ret(S::*)(Args...) volatile noexcept(noex)> {};

	template<typename Ret, typename S, typename... Args, bool noex>
	struct impl<Ret(S::*)(Args...) const noexcept(noex)> : xieite::type<Ret(S::*)(Args...) const volatile noexcept(noex)> {};
