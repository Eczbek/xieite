...
namespace DETAIL_XIEITE::add_c_referent {
	...
	template<typename T>
	struct impl<T*> : xieite::type<const T*> {};

	template<typename Ret, typename... Args, bool noex>
	struct impl<Ret(Args...) noexcept(noex)> : xieite::type<Ret(Args...) const noexcept(noex)> {};

	template<typename Ret, typename... Args, bool noex>
	struct impl<Ret(Args...) volatile noexcept(noex)> : xieite::type<Ret(Args...) const volatile noexcept(noex)> {};
	...
	struct impl<Ret(S::*)(Args...) noexcept(noex)> : xieite::type<Ret(S::*)(Args...) const noexcept(noex)> {};

	template<typename Ret, typename S, typename... Args, bool noex>
	struct impl<Ret(S::*)(Args...) volatile noexcept(noex)> : xieite::type<Ret(S::*)(Args...) const volatile noexcept(noex)> {};
