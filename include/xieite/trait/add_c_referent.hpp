...
namespace DETAIL_XIEITE::add_c_referent {
	...
	struct impl<Ret(Args...) noexcept(noex)> : xieite::wrap_type<Ret(Args...) const noexcept(noex)> {};

	template<typename Ret, typename... Args, bool noex>
	struct impl<Ret(Args...) volatile noexcept(noex)> : xieite::wrap_type<Ret(Args...) const volatile noexcept(noex)> {};
	...
	struct impl<Ret(S::*)(Args...) noexcept(noex)> : xieite::wrap_type<Ret(S::*)(Args...) const noexcept(noex)> {};

	template<typename Ret, typename S, typename... Args, bool noex>
	struct impl<Ret(S::*)(Args...) volatile noexcept(noex)> : xieite::wrap_type<Ret(S::*)(Args...) const volatile noexcept(noex)> {};
