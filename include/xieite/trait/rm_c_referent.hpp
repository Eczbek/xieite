...
namespace DETAIL_XIEITE::rm_c_referent {
	...
	template<typename T>
	struct impl<const T*> : xieite::type<T*> {};

	template<typename Ret, typename... Args, bool noex>
	struct impl<Ret(Args...) const noexcept(noex)> : xieite::type<Ret(Args...) noexcept(noex)> {};

	template<typename Ret, typename... Args, bool noex>
	struct impl<Ret(Args...) const volatile noexcept(noex)> : xieite::type<Ret(Args...) volatile noexcept(noex)> {};
	...
	struct impl<Ret(S::*)(Args...) const noexcept(noex)> : xieite::type<Ret(S::*)(Args...) noexcept(noex)> {};

	template<typename Ret, typename S, typename... Args, bool noex>
	struct impl<Ret(S::*)(Args...) const volatile noexcept(noex)> : xieite::type<Ret(S::*)(Args...) volatile noexcept(noex)> {};
