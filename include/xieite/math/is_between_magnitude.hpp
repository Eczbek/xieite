...
namespace xieite::math {
	...
	[[nodiscard]] constexpr bool isBetweenMagnitude(const Number value, const Number limit1, const Number limit2, const bool downInclusive = true, const bool upInclusive = true) noexcept {
		const Number down = xieite::math::closestTo(static_cast<Number>(0), limit1, limit2);
