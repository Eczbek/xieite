...
namespace xieite::math {
	...
	[[nodiscard]] constexpr bool isBetweenFixed(const Number value, const Number limit1, const Number limit2, const bool floorInclusive = true, const bool ceilingInclusive = true) noexcept {
