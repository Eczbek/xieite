...
namespace xieite::math {
	...
	[[nodiscard]] constexpr xieite::types::MaybeUnsigned<Integral> absolute(const Integral value) noexcept {
		return xieite::math::isNegative(value) ? -static_cast<xieite::types::MaybeUnsigned<Integral>>(value) : static_cast<xieite::types::MaybeUnsigned<Integral>>(value); // This works so don't touch it
	}
