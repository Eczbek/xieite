#ifndef DETAIL_XIEITE_HEADER_IO_LOGGER
#	define DETAIL_XIEITE_HEADER_IO_LOGGER
#
#	include <chrono>
#	include <cstdio>
#	include <format>
...
namespace DETAIL_XIEITE::logger {
...
#define DETAIL_XIEITE_LOGGER(_name, _color, _tag) \
	...
	struct _name : DETAIL_XIEITE::logger::impl<_color, _tag, DETAIL_XIEITE_Args...> { \
		using DETAIL_XIEITE::logger::impl<_color, _tag, DETAIL_XIEITE_Args...>::impl; \
	}; \
	\
	template<typename... DETAIL_XIEITE_Args> \
