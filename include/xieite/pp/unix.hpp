...
#	define XIEITE_UNIX_VER(_type, _op, _major, ...) DETAIL_XIEITE_UNIX_VER(_op, XIEITE_UNIX_MAJOR_##_type, XIEITE_UNIX_MINOR_##_type, XIEITE_UNIX_PATCH_##_type, _major, __VA_ARGS__ __VA_OPT__(,) 0, 0)
#
#	define DETAIL_XIEITE_UNIX_VER(_op, _major0, _minor0, _patch0, _major1, _minor1, _patch1, ...) (((((0 _op 0) && !(0 _op 1) && !(1 _op 0)) || (!(0 _op 0) && (0 _op 1) && (1 _op 0))) && (((_major0) _op (_major1)) && ((_minor0) _op (_minor1)) && ((_patch0) _op (_patch1)))) || ((_major0) _op (_major1)) || (((_major0) == (_major1)) && ((_minor0) _op (_minor1))) || (((_minor0) == (_minor1)) && ((_patch0) _op (_patch1))))
#
