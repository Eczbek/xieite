...
#	define XIEITE_ATTR_ACQUIRE_HANDLE(_handle) DETAIL_XIEITE_ATTR(CLANG, clang, acquire_handle, (_handle))
...
#	define XIEITE_ATTR_ALIAS(_target) DETAIL_XIEITE_ATTR(GCC, gnu, alias, (#_target))
...
#	define XIEITE_ATTR_ALLOC_ALIGN(_pos) DETAIL_XIEITE_ATTR(GCC, gnu, alloc_align, (_pos))
...
#	define XIEITE_ATTR_BPF_TYPE_TAG(_str) DETAIL_XIEITE_ATTR(CLANG, clang, bpf_type_tag, (_str))
...
#	define XIEITE_ATTR_BTF_DECL_TAG(_str) DETAIL_XIEITE_ATTR(CLANG, clang, btf_decl_tag, (_str))
...
#	define XIEITE_ATTR_CF_RET_RETAIN DETAIL_XIEITE_ATTR(CLANG, clang, fg_returns_retained)
...
#	define XIEITE_ATTR_CO_RET_TYPE DETAIL_XIEITE_ATTR(CLANG, clang, coro_return_type)
...
#	define XIEITE_ATTR_DECLARE_TARGET XIEITE_PRAGMA_CLANG(omp declare _target)
...
#	define XIEITE_ATTR_ENFORCE_TCB(_name) DETAIL_XIEITE_ATTR(CLANG, clang, enforce_tcb, (_name))
#	define XIEITE_ATTR_ENFORCE_TCB_LEAF(_name) DETAIL_XIEITE_ATTR(CLANG, clang, enforce_tcb_leaf, (_name))
#	define XIEITE_ATTR_ENUM_EXT(_kind) DETAIL_XIEITE_ATTR(CLANG, clang, enum_extensibility, (_kind))
#	define XIEITE_ATTR_ERROR(_msg) DETAIL_XIEITE_ATTR(GCC, gnu, _msg, (_msg))
...
#	define XIEITE_ATTR_EXPORT_NAME(_name) DETAIL_XIEITE_ATTR(CLANG, clang, export_name, (_name))
#	if XIEITE_COMPILER_TYPE_MSVC
...
#	define XIEITE_ATTR_FMT_ARG(_idx) DETAIL_XIEITE_ATTR(GCC, gnu, format_arg, (_idx))
...
#	define XIEITE_ATTR_IFUNC(_resolver) DETAIL_XIEITE_ATTR(GCC, gnu, ifunc, (_resolver))
#	if XIEITE_COMPILER_TYPE_MSVC
#		define XIEITE_ATTR_IMPORT __declspec(dllimport)
#	else
#		define XIEITE_ATTR_IMPORT DETAIL_XIEITE_ATTR(GCC, gnu, dllimport)
#	endif
#	define XIEITE_ATTR_IMPORT_MODULE(_name) DETAIL_XIEITE_ATTR(CLANG, clang, import_module, (_name))
#	define XIEITE_ATTR_IMPORT_NAME(_name) DETAIL_XIEITE_ATTR(CLANG, clang, import_name, (_name))
...
#	define XIEITE_ATTR_INTERRUPT(...) DETAIL_XIEITE_ATTR(GCC, gnu, interrupt, __VA_OPT__((_type)))
#	define XIEITE_ATTR_INTERRUPT_HANDLER DETAIL_XIEITE_ATTR(GCC, gnu, interrupt_handler)
#	define XIEITE_ATTR_INTERRUPT_SAVE_FP(_type) DETAIL_XIEITE_ATTR(,, interrupt_save_fp, (_type))
...
#	define XIEITE_ATTR_LIFETIME_CAPTURE_BY(_param) DETAIL_XIEITE_ATTR(CLANG, clang, lifetime_capture_by, (_param))
#	if XIEITE_LANG_VER(CPP, >=, 2020)
...
#	define XIEITE_ATTR_METHOD_FAMILY(_family) DETAIL_XIEITE_ATTR(CLANG, clang, objc_method_family, (_family))
...
#	define XIEITE_ATTR_MODE(_name) DETAIL_XIEITE_ATTR(GCC, gnu, mode, (_name))
#	define XIEITE_ATTR_MODEL(_name) DETAIL_XIEITE_ATTR(GCC, gnu, model_name, (_name))
...
#	define XIEITE_ATTR_NO_CF_RET_RETAIN DETAIL_XIEITE_ATTR(CLANG, clang, cf_returns_not_retained)
...
#	define XIEITE_ATTR_NO_NS_RET_RETAIN DETAIL_XIEITE_ATTR(CLANG, clang, ns_returns_not_retained)
#	define XIEITE_ATTR_NO_OPTIMIZE DETAIL_XIEITE_ATTR(CLANG, clang, optnone)
#	define XIEITE_ATTR_NO_OS_RET_RETAIN DETAIL_XIEITE_ATTR(CLANG, clang, os_returns_not_retained)
...
#		define XIEITE_ATTR_NO_RET [[noreturn]]
#	elif XIEITE_LANG_VER(C, >=, 2011)
#		define XIEITE_ATTR_NO_RET _Noreturn
#	else
#		define XIEITE_ATTR_NO_RET DETAIL_XIEITE_ATTR(,, noreturn)
#	endif
#	define XIEITE_ATTR_NO_RET_ANALYZER DETAIL_XIEITE_ATTR(,, analyzer_noreturn)
...
#	define XIEITE_ATTR_NS_ERROR_DOMAIN(_domain) DETAIL_XIEITE_ATTR(,, ns_error_domain, (_domain))
#	define XIEITE_ATTR_NS_RET_AUTORELEASE DETAIL_XIEITE_ATTR(CLANG, clang, ns_returns_autoreleased)
#	define XIEITE_ATTR_NS_RET_RETAIN DETAIL_XIEITE_ATTR(CLANG, clang, ns_returns_retained)
...
#	define XIEITE_ATTR_OS_RET_RETAIN DETAIL_XIEITE_ATTR(CLANG, clang, os_returns_retained)
#	define XIEITE_ATTR_OS_RET_RETAIN_ON_NONZERO DETAIL_XIEITE_ATTR(CLANG, clang, os_returns_retained_on_non_zero)
#	define XIEITE_ATTR_OS_RET_RETAIN_ON_ZERO DETAIL_XIEITE_ATTR(CLANG, clang, os_returns_retained_on_zero)
...
#	define XIEITE_ATTR_OWNERSHIP_RET(...) DETAIL_XIEITE_ATTR(CLANG, clang, ownership_returns, (__VA_ARGS__))
...
#	define XIEITE_ATTR_PREFER_NAME(_str) DETAIL_XIEITE_ATTR(CLANG, clang, preferred_name, (_str))
...
#	define XIEITE_ATTR_RELEASE_HANDLE(_handle) DETAIL_XIEITE_ATTR(CLANG, clang, release_handle, (_handle))
...
#	define XIEITE_ATTR_REG_PARAM(_n) DETAIL_XIEITE_ATTR(GCC, gnu, regparm, (_n))
...
#	define XIEITE_ATTR_RET(_kind) DETAIL_XIEITE_ATTR(GCC, gnu, function_return, (_kind))
#	define XIEITE_ATTR_RET_INNER_PTR DETAIL_XIEITE_ATTR(CLANG, clang, objc_returns_inner_pointer)
#	define XIEITE_ATTR_RET_LOCK DETAIL_XIEITE_ATTR(,, lock_returned)
#	if XIEITE_COMPILER_TYPE_MSVC
#		define XIEITE_ATTR_RET_NONNULL _Ret_notnull_
#	else
#		define XIEITE_ATTR_RET_NONNULL DETAIL_XIEITE_ATTR(GCC, gnu, returns_nonnull)
#	endif
#	define XIEITE_ATTR_RET_TWICE DETAIL_XIEITE_ATTR(GCC, gnu, returns_twice)
#	define XIEITE_ATTR_RET_TYPESTATE DETAIL_XIEITE_ATTR(CLANG, clang, return_typestate)
...
#	if XIEITE_COMPILER_TYPE_MSVC
#		define XIEITE_ATTR_SECTION(_name) __declspec(allocate(_name))
#	else
#		define XIEITE_ATTR_SECTION(_name) DETAIL_XIEITE_ATTR(GCC, gnu, section, (_name))
#	endif
#	if XIEITE_COMPILER_TYPE_MSVC
...
#	define XIEITE_ATTR_SET_TYPESTATE(_state) DETAIL_XIEITE_ATTR(CLANG, clang, set_typestate, (_state))
...
#	define XIEITE_ATTR_SSE_REG_PARAM(_n) DETAIL_XIEITE_ATTR(GCC, gnu, sseregparm, (_n))
...
#	define XIEITE_ATTR_SWIFT_ASYNC_NAME(_name) DETAIL_XIEITE_ATTR(,, swift_async_name, (_name))
#	define XIEITE_ATTR_SWIFT_ATTR(_attr) DETAIL_XIEITE_ATTR(,, swift_attr, (_attr))
...
#	define XIEITE_ATTR_SWIFT_ERROR(_msg) DETAIL_XIEITE_ATTR(,, swift_error, (_msg))
...
#	define XIEITE_ATTR_SWIFT_NAME(_name) DETAIL_XIEITE_ATTR(,, swift_name, (_name))
#	define XIEITE_ATTR_SWIFT_NEW_TYPE(_kind) DETAIL_XIEITE_ATTR(,, swift_newtype, (_kind))
...
#	define XIEITE_ATTR_SYMVER(_ver) DETAIL_XIEITE_ATTR(GCC, gnu, symver, (_ver))
...
#	define XIEITE_ATTR_TARGET(...) DETAIL_XIEITE_ATTR(GCC, gnu, _target, (__VA_ARGS__))
...
#	define XIEITE_ATTR_TEST_TYPESTATE(_state) DETAIL_XIEITE_ATTR(CLANG, clang, test_typestate, (_state))
...
#	define XIEITE_ATTR_TSL_MODEL(_kind) DETAIL_XIEITE_ATTR(GCC, gnu, tls_model, (_kind))
...
#	endif
#	define XIEITE_ATTR_USE_HANDLE(_handle) DETAIL_XIEITE_ATTR(CLANG, clang, use_handle, (_handle))
...
#	define XIEITE_ATTR_VER(_ver) DETAIL_XIEITE_ATTR(GCC, gnu, version_id, (_ver))
...
#	define XIEITE_ATTR_WARN(_msg) DETAIL_XIEITE_ATTR(GCC, gnu, warning, (_msg))
