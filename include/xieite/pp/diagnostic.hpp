...
#	define XIEITE_DIAGNOSTIC_ERR(_msg)
#	define XIEITE_DIAGNOSTIC_ERR_GCC(_msg)
#	define XIEITE_DIAGNOSTIC_ERR_CLANG(_msg)
#	define XIEITE_DIAGNOSTIC_ERR_MSVC(_msg)
...
#		define XIEITE_DIAGNOSTIC_ERR(_msg) XIEITE_PRAGMA(GCC error _msg)
#
#		undef XIEITE_DIAGNOSTIC_ERR_CLANG
#		define XIEITE_DIAGNOSTIC_ERR_CLANG(_msg) XIEITE_DIAGNOSTIC_ERR(_msg)
#
...
#		define XIEITE_DIAGNOSTIC_ERR_GCC(_msg) XIEITE_DIAGNOSTIC_ERR(_msg)
#
#		undef XIEITE_DIAGNOSTIC_PUSH
...
#
#		undef XIEITE_DIAGNOSTIC_ERR
#		define XIEITE_DIAGNOSTIC_ERR(_msg) XIEITE_PRAGMA(message("\x1B[35m" _msg "\x1B[0m"))
#
#		undef XIEITE_DIAGNOSTIC_ERR_MSVC
#		define XIEITE_DIAGNOSTIC_ERR_MSVC(_msg) XIEITE_DIAGNOSTIC_ERR(_msg)
#
#		undef XIEITE_DIAGNOSTIC_PUSH
