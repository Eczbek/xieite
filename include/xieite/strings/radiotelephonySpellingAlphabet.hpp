...
namespace xieite::strings {
	inline constexpr std::array<std::string_view, std::numeric_limits<char>::max() - std::numeric_limits<char>::min() + 1> radiotelephonySpellingAlphabet = ([] {
		decltype(radiotelephonySpellingAlphabet) result;
