...
#elif (XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2014) || (XIEITE_LANGUAGE_C >= XIEITE_LANGUAGE_C_2023)
...
#if (XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2017) || (XIEITE_COMPILER_LEAST(GCC, 8, 0, 0) && (XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2011))
...
#elif XIEITE_COMPILER_TYPE_CLANG && (XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2011)
...
#if XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2017
...
#elif XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2011
...
#elif XIEITE_LANGUAGE_CPP >= XIEITE_LANGUAGE_CPP_2020
