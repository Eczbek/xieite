...
namespace xieite::types {
	...
	public:
		...
		using At = decltype(([]<std::size_t... i>(std::index_sequence<i...>) -> decltype(([]<typename Type>(std::void_t<decltype(i)>*..., Type*, ...) -> Type {})(static_cast<Types*>(nullptr)...)) {})(std::make_index_sequence<index>()));
		...
		using Reverse = decltype(([]<std::size_t... i>(std::index_sequence<i...>) -> xieite::types::List<xieite::types::List<Types...>::At<sizeof...(Types) - i - 1>...> {})(std::make_index_sequence<sizeof...(Types)>()));
