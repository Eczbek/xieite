...
namespace xieite::detail {
	...
	template<typename Return_, typename Class_, typename... Arguments_>
	struct MaybeVolatileQualified<Return_(Class_::*)(Arguments_...) const volatile, true>
	: std::type_identity<Return_(Class_::*)(Arguments_...) const volatile> {};

	template<typename Return_, typename Class_, typename... Arguments_>
	struct MaybeVolatileQualified<Return_(Class_::*)(Arguments_...) const volatile, false>
	: std::type_identity<Return_(Class_::*)(Arguments_...) const> {};
	...
	template<typename Return_, typename Class_, typename... Arguments_>
	struct MaybeVolatileQualified<Return_(Class_::*)(Arguments_...) const volatile noexcept, true>
	: std::type_identity<Return_(Class_::*)(Arguments_...) const volatile noexcept> {};

	template<typename Return_, typename Class_, typename... Arguments_>
	struct MaybeVolatileQualified<Return_(Class_::*)(Arguments_...) const volatile noexcept, false>
	: std::type_identity<Return_(Class_::*)(Arguments_...) const noexcept> {};
...
namespace xieite::types {
	...
	using MaybeVolatileQualified = xieite::detail::MaybeVolatileQualified<Function_, volatileQualified_>::type;
}
