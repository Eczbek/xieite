...
#
#	define XTE_STDLIB(NAME, OP, MAJOR, ...) \
		DETAIL_XTE_STDLIB(OP, \
			XTE_STDLIB_##NAME##_MAJOR, XTE_STDLIB_##NAME##_MINOR, XTE_STDLIB_##NAME##_PATCH, \
...
#			define XTE_STDLIB_GNU_C_MINOR (__GLIBC_MINOR__)
#		else
...
#		else
#			define XTE_STDLIB_GNU_CPP_MINOR (__GLIBCXX__)
#		endif
#	endif
#
#	ifdef __IBMCPP__
...
#		elif defined(__KLIBC_VERSION__)
#			define XTE_STDLIB_KLIBC_MAJOR ((__KLIBC_VERSION__) / 0x1000000)
#			define XTE_STDLIB_KLIBC_MINOR ((__KLIBC_VERSION__) / 0x10000 % 0x100)
...
#		define XTE_STDLIB_LLVM_CPP_MINOR (_LIBCPP_VERSION / 100 % 100)
...
#		define XTE_STDLIB_SGI_CPP_MINOR ((__SGI_STL) / 10 % 10)
...
#		define XTE_STDLIB_VMS_C_MINOR ((__CTRL_VER) / 100000 % 100)
...
#			define XTE_STDLIB_Z_C_MINOR ((__LIBREL__) / 10000 % 100)
#			define XTE_STDLIB_Z_C_PATCH ((__LIBREL__) % 10000)
#		else
#			define XTE_STDLIB_Z_C_MAJOR ((__TARGET_LIB__) / 1000000)
#			define XTE_STDLIB_Z_C_MINOR ((__TARGET_LIB__) / 10000 % 100)
...
#	endif
#
#	define DETAIL_XTE_STDLIB(OP, LHS_MAJOR, LHS_MINOR, LHS_PATCH, RHS_MAJOR, RHS_MINOR, RHS_PATCH, ...) \
