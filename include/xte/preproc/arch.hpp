#ifndef DETAIL_XTE_HEADER_PREPROC_ARCH
#	define DETAIL_XTE_HEADER_PREPROC_ARCH
#
...
#			define XTE_ARCH_AARCH32_MAJOR 6
...
#			define XTE_ARCH_AARCH32_MAJOR 5
...
#
#	ifdef _AM29K
#		undef XTE_ARCH_AM29000
#		define XTE_ARCH_AM29000 1
#	endif
#
...
#			define XTE_ARCH_ATMEL_AVR_MINOR 0
#		elif AVR_ARCH == 51
#			define XTE_ARCH_ATMEL_AVR_MAJOR 5
#			define XTE_ARCH_ATMEL_AVR_MINOR 1
#		elif AVR_ARCH == 5
#			define XTE_ARCH_ATMEL_AVR_MAJOR 5
#			define XTE_ARCH_ATMEL_AVR_MINOR 0
#		elif AVR_ARCH == 4
#			define XTE_ARCH_ATMEL_AVR_MAJOR 4
#			define XTE_ARCH_ATMEL_AVR_MINOR 0
#		elif AVR_ARCH == 35
#			define XTE_ARCH_ATMEL_AVR_MAJOR 3
#			define XTE_ARCH_ATMEL_AVR_MINOR 5
#		elif AVR_ARCH == 31
#			define XTE_ARCH_ATMEL_AVR_MAJOR 3
#			define XTE_ARCH_ATMEL_AVR_MINOR 1
#		elif AVR_ARCH == 3
...
#			define XTE_ARCH_ATMEL_AVR_MINOR 0
#		elif AVR_ARCH == 25
#			define XTE_ARCH_ATMEL_AVR_MAJOR 2
#			define XTE_ARCH_ATMEL_AVR_MINOR 5
#		elif AVR_ARCH == 2
#			define XTE_ARCH_ATMEL_AVR_MAJOR 2
#			define XTE_ARCH_ATMEL_AVR_MINOR 0
#		elif AVR_ARCH == 1
#			define XTE_ARCH_ATMEL_AVR_MAJOR 1
#			define XTE_ARCH_ATMEL_AVR_MINOR 0
#		else
#			define XTE_ARCH_ATMEL_AVR_MAJOR 0
#			define XTE_ARCH_ATMEL_AVR_MAJOR 0
...
#			define XTE_ARCH_BLACKFIN_MAJOR 526
#		elif defined(__ADSPBF525__) || defined(__ADSPBF525C__)
#			define XTE_ARCH_BLACKFIN_MAJOR 525
#		elif defined(__ADSPBF524__) || defined(__ADSPBF524C__)
#			define XTE_ARCH_BLACKFIN_MAJOR 524
...
#	endif
#
#	if defined(__CR16C__) || defined(__CR16CP__) || defined(__CR16__)
#		undef XTE_ARCH_COMPACTRISC
#		define XTE_ARCH_COMPACTRISC 1
#	endif
#
#	ifdef __convex__
...
#	ifdef _CRAY
#		undef XTE_ARCH_CRAY
#		define XTE_ARCH_CRAY 1
#	endif
#
#	ifdef _CRAYT3D
#		undef XTE_ARCH_CRAY_T3D
#		define XTE_ARCH_CRAY_T3D 1
#	endif
#
#	ifdef _CRAYT3E
#		undef XTE_ARCH_CRAY_T3E
#		define XTE_ARCH_CRAY_T3E 1
#	endif
#
#	if defined(__CSKY__) || defined(__csky__)
#		undef XTE_ARCH_CSKY
#		define XTE_ARCH_CSKY 1
#	endif
#
#	ifdef __D10V__
#		undef XTE_ARCH_D10V
#		define XTE_ARCH_D10V 1
#	endif
#
#	ifdef __D30V__
#		undef XTE_ARCH_D30V
#		define XTE_ARCH_D30V 1
#	endif
#
#	ifdef __epiphany__
#		undef XTE_ARCH_EPIPHANY
#		define XTE_ARCH_EPIPHANY 1
#	endif
#
...
#
#	ifdef __frv__
#		undef XTE_ARCH_FUJITSU_FR_V
#		define XTE_ARCH_FUJITSU_FR_V 1
#	endif
#
#	if defined(__fr30) || defined(__fr30__) || defined(fr30)
#		undef XTE_ARCH_FR30
#		define XTE_ARCH_FR30 1
#	endif
#
#	ifdef __FT32__
#		undef XTE_ARCH_FT32
#		define XTE_ARCH_FT32 1
#	endif
#
#	if defined(__H8300H__) || defined(__H8300SX__) || defined(__H8300S__) || defined(__H8300__) || defined(__H8500__) || defined(__h8300__)
#		undef XTE_ARCH_H8300
#		define XTE_ARCH_H8300 1
#	endif
#
#	ifdef __hexagon__
...
#		undef XTE_ARCH_HP_800
#		define XTE_ARCH_HP_800 1
#	endif
#
#	ifdef __hp9000
...
#
#	ifdef ibm032
#		undef XTE_ARCH_IBM_SYSTEM_32
#		define XTE_ARCH_IBM_SYSTEM_32 1
#	endif
#
#	if defined(_370) || defined(__370__) || defined(__THW_370__) || defined(ibm370)
#		undef XTE_ARCH_IBM_SYSTEM_370
#		define XTE_ARCH_IBM_SYSTEM_370 1
#	endif
#
#	if defined(_390) || defined(__s390__) || defined(__s390x__)
#		undef XTE_ARCH_IBM_SYSTEM_390
#		define XTE_ARCH_IBM_SYSTEM_390 1
#	endif
#
#	if defined(__SYSC_ZARCH__) || defined(__zarch__)
#		undef XTE_ARCH_IBM_Z
#		define XTE_ARCH_IBM_Z 1
#	endif
#
#	ifdef __IP2K__
#		undef XTE_ARCH_IP2000
#		define XTE_ARCH_IP2000 1
#	endif
#
#	ifdef __iq2000__
#		undef XTE_ARCH_IQ2000
#		define XTE_ARCH_IQ2000 1
#	endif
#
#	ifdef __lm32__
#		undef XTE_ARCH_LATTICEMICO32
#		define XTE_ARCH_LATTICEMICO32 1
#	endif
#
#	ifdef __loongarch__
...
#		undef XTE_ARCH_M_CORE
#		define XTE_ARCH_M_CORE 1
#	endif
#
#	ifdef __m32c__
#		undef XTE_ARCH_M32C
#		define XTE_ARCH_M32C 1
#	endif
#
#	if defined(__M32R__) || defined(__m32r__)
#		undef XTE_ARCH_M32R
#		define XTE_ARCH_M32R 1
#	endif
#
...
#		undef XTE_ARCH_MMIX
#		define XTE_ARCH_MMIX 1
#	endif
#
#	if defined(__MN10200__) || defined(__mn10200__)
#		undef XTE_ARCH_MN10200
#		define XTE_ARCH_MN10200 1
#	endif
#
#	if defined(__MN10300__) || defined(__mn10300__)
#		undef XTE_ARCH_MN10300
#		define XTE_ARCH_MN10300 1
#	endif
#
...
#			define XTE_ARCH_MOTOROLA_68000_MAJOR 3
...
#			define XTE_ARCH_MOTOROLA_68000_MAJOR 2
...
#			define XTE_ARCH_MOTOROLA_68000_MAJOR 1
#		else
#			define XTE_ARCH_MOTOROLA_68000_MAJOR 0
#		endif
#	endif
#
#	if defined(__m88000) || defined(__m88000__) || defined(__m88k) || defined(__m88k__) || defined(_m88000) || defined(_m88k) || defined(m88000) || defined(m88k)
#		undef XTE_ARCH_MOTOROLA_88000
#		define XTE_ARCH_MOTOROLA_88000 1
#	endif
#
#	if defined(__mc86hc11__) || defined(__mc86hc12__) || defined(__mc86hc1x__)
#		undef XTE_ARCH_MOTOROLA_HC11
#		define XTE_ARCH_MOTOROLA_HC11 1
#	endif
#
#	if defined(__MCORE__) || defined(__mcore__)
#		undef XTE_ARCH_MOTOROLA_M_CORE
#		define XTE_ARCH_MOTOROLA_M_CORE 1
#	endif
#
#	if defined(MOXIE) || defined(__MOXIE) || defined(__MOXIE__) || defined(__moxie) || defined(__moxie__) || defined(moxie)
#		undef XTE_ARCH_MOXIE
#		define XTE_ARCH_MOXIE 1
#	endif
#
#	ifdef __MSP430__
#		undef XTE_ARCH_MSP430
#		define XTE_ARCH_MSP430 1
#	endif
#
#	if defined(__NDS32__) || defined(__nds32__)
#		undef XTE_ARCH_NDS32
#		define XTE_ARCH_NDS32 1
#	endif
#
#	if defined(__NEC__) || defined(__ve) || defined(__ve__)
#		undef XTE_ARCH_NEC_SX_AURORA_TSUBASA
#		define XTE_ARCH_NEC_SX_AURORA_TSUBASA 1
#	endif
#
#	if defined(NIOS2) || defined(__NIOS2) || defined(__NIOS2__) || defined(__nios2) || defined(__nios2__) || defined(nios2)
#		undef XTE_ARCH_NIOS_II
#		define XTE_ARCH_NIOS_II 1
#	endif
#
#	if defined(__OR1KND__) || defined(__OR1K__) || defined(__or1k__)
#		undef XTE_ARCH_OPENRISC
#		define XTE_ARCH_OPENRISC 1
#	endif
#
...
#		undef XTE_ARCH_PDP_11
#		define XTE_ARCH_PDP_11 1
#	endif
#
...
#			define XTE_ARCH_POWERPC_MAJOR 605
#		elif defined(_ARCH_604) || defined(__ppc604__)
#			define XTE_ARCH_POWERPC_MAJOR 604
#		elif defined(_ARCH_603) || defined(__ppc603__)
#			define XTE_ARCH_POWERPC_MAJOR 603
...
#	ifdef __CUDA_ARCH__
#		undef XTE_ARCH_PTX
#		define XTE_ARCH_PTX 1
#	endif
#
#	ifdef pyr
#		undef XTE_ARCH_PYRAMID_9810
#		define XTE_ARCH_PYRAMID_9810 1
#	endif
#
#	ifdef __RX__
#		undef XTE_ARCH_RENESAS_RX
#		define XTE_ARCH_RENESAS_RX 1
#	endif
#
#	if defined(__riscv) || defined(__riscv64) || defined(__riscv__) || defined(__riscv_xlen)
#		undef XTE_ARCH_RISC_V
#		define XTE_ARCH_RISC_V 1
#	endif
#
#	ifdef __RL78__
#		undef XTE_ARCH_RL78
#		define XTE_ARCH_RL78 1
#	endif
#
...
#		undef XTE_ARCH_RS_6000
#		define XTE_ARCH_RS_6000 1
#	endif
#
...
#			define XTE_ARCH_SUPERH_MAJOR 4
#		elif defined(__SH3__) || defined(__sh3__)
#			define XTE_ARCH_SUPERH_MAJOR 3
#		elif defined(__SH2__) || defined(__sh2__)
#			define XTE_ARCH_SUPERH_MAJOR 2
#		elif defined(__SH1__) || defined(__sh1__)
#			define XTE_ARCH_SUPERH_MAJOR 1
#		else
#			define XTE_ARCH_SUPERH_MAJOR 0
#		endif
#	endif
...
#		undef XTE_ARCH_SYNOPSYS_ARC
#		define XTE_ARCH_SYNOPSYS_ARC 1
#	endif
#
#	ifdef tahoe
#		undef XTE_ARCH_TAHOE
#		define XTE_ARCH_TAHOE 1
#	endif
#
#	ifdef __TIC80__
#		undef XTE_ARCH_TIC_80
#		define XTE_ARCH_TIC_80 1
#	endif
#
#	ifdef __tilepro__
#		undef XTE_ARCH_TILERA_TILEPRO64
#		define XTE_ARCH_TILERA_TILEPRO64 1
#	endif
#
#	ifdef __tilegx__
#		undef XTE_ARCH_TILERA_TILE_GX
#		define XTE_ARCH_TILERA_TILE_GX 1
#	endif
#
...
#
#	ifdef __TMS470__
#		undef XTE_ARCH_TMS470
#		define XTE_ARCH_TMS470 1
#	endif
#
#	if defined(__v800) || defined(__v800__) || defined(__v850) || defined(__v850__)
#		undef XTE_ARCH_V850
#		define XTE_ARCH_V850 1
#	endif
#
#	if defined(VAX) || defined(__VAX) || defined(__vax) || defined(vax)
#		undef XTE_ARCH_VAX
#		define XTE_ARCH_VAX 1
#	endif
#
#	if defined(__ASMJS__) || defined(__EMSCRIPTEN__) || defined(__WASM__) || defined(__wasi__) || defined(__wasm) || defined(__wasm32__) || defined(__wasm64__) || defined(__wasm__)
#		undef XTE_ARCH_WASM
#		define XTE_ARCH_WASM 1
#	endif
#
#	ifdef __W65__
#		undef XTE_ARCH_WDC_65C02
#		define XTE_ARCH_WDC_65C02 1
#	endif
#
#	if defined(__8080__) || defined(__8085__) || defined(__Z180) || defined(__Z80)
#		undef XTE_ARCH_X80
#		define XTE_ARCH_X80 1
#	endif
#
...
#		undef XTE_ARCH_X86_64
#		define XTE_ARCH_X86_64 1
#	endif
#
#	if _XBOX_VER >= 200
#		undef XTE_ARCH_XENON
#		define XTE_ARCH_XENON 1
#	endif
#
#	if defined(__xstormy16) || defined(__xstormy16__) || defined(xstormy16)
#		undef XTE_ARCH_XSTORMY16
#		define XTE_ARCH_XSTORMY16 1
#	endif
#
#	if defined(__XTENSA__) || defined(__xtensa__)
#		undef XTE_ARCH_XTENSA
#		define XTE_ARCH_XTENSA 1
#	endif
#
