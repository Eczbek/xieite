...
#	define DETAIL_XTE_LAMBDA_DECL(CAPTURES, THIS, ...) <decltype(auto)... __VA_OPT__($$ XTE_IIF(THIS)(, typename $$this)())>__VA_OPT__([[nodiscard]])(__VA_OPT__(XTE_IIF(THIS)([[maybe_unused]] this $$this&& $this,)() [[maybe_unused]]) auto&&... __VA_OPT__($)) XTE_IIF(CAPTURES)()(XTE_IF(XTE_ANY(__VA_ARGS__))(XTE_IIF(THIS)()(static))(static)) noexcept __VA_OPT__(DETAIL_XTE_LAMBDA_CHECK(THIS, noexcept(__VA_ARGS__)) -> decltype(auto) requires DETAIL_XTE_LAMBDA_CHECK(THIS, requires { __VA_ARGS__; })) DETAIL_XTE_LAMBDA_BODY(__VA_ARGS__)
#	define DETAIL_XTE_LAMBDA_CHECK(THIS, ...) (requires (XTE_IIF(THIS)($$this&& $this,)() decltype($)&&... $) { requires ([](XTE_IIF(THIS)([[maybe_unused]] auto&& $this,)() auto&&... $) DETAIL_XTE_LAMBDA_BODY(__VA_ARGS__))(XTE_IIF(THIS)(XTE_FWD($this),)() XTE_FWD($)...); })
