...
namespace DETAIL_XTE::drop_const_func {
	...
	constexpr auto impl<xte::member_type<class_type, return_type(arg_types...) const noexcept(noex_spec)>> = ^^xte::member_type<class_type, return_type(arg_types...) noexcept(noex_spec)>;

	template<typename return_type, typename... arg_types, bool noex_spec, typename class_type>
	constexpr auto impl<xte::member_type<class_type, return_type(arg_types..., ...) const noexcept(noex_spec)>> = ^^xte::member_type<class_type, return_type(arg_types..., ...) noexcept(noex_spec)>;

	template<typename return_type, typename... arg_types, bool noex_spec, typename class_type>
	constexpr auto impl<xte::member_type<class_type, return_type(arg_types...) const volatile noexcept(noex_spec)>> = ^^xte::member_type<class_type, return_type(arg_types...) volatile noexcept(noex_spec)>;
