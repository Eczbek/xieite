...
export namespace xieite {
	...
	[[nodiscard]] constexpr std::basic_string<Ch, Traits, Alloc> str_trunc(std::basic_string_view<Ch, Traits>& strv, std::size_t size, std::basic_string_view<Ch, Traits, Alloc> sfx = "") noexcept {
	...
	template<typename Ch = char, typename Traits = std::char_traits<Ch>, typename Alloc = std::allocator<Ch>>
	[[nodiscard]] constexpr std::basic_string<Ch, Traits, Alloc> str_trunc(std::basic_string_view<Ch, Traits, Alloc> strv, std::size_t size, Ch sfx) noexcept {
