...
export namespace xieite {
	...
	public:
		...
		void fg(const xieite::color<channels>& color) noexcept {
			std::print(this->output, "{}", xieite::io_handle::fg_code(color));
		}
		...
		void fg_reset() noexcept {
			std::print(this->output, "{}", xieite::io_handle::fg_reset_code());
		}
		...
		void bg(const xieite::color<channels>& color) noexcept {
			std::print(this->output, "{}", xieite::io_handle::bg_code(color));
		}
		...
		void bg_reset() noexcept {
			std::print(this->output, "{}", xieite::io_handle::bg_reset_code());
		}
		...
		void bold(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::bold_code(value));
		}
		...
		void italic(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::italic_code(value));
		}
		...
		void underline(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::underline_code(value));
		}
		...
		void blink(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::blink_code(value));
		}
		...
		void invis(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::invis_code(value));
		}
		...
		void striked(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::striked_code(value));
		}
		...
		void swap_colors(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::swap_colors_code(value));
		}
		...
		void reset_style() noexcept {
			...
			std::print(this->output, "{}", xieite::io_handle::reset_style_code());
		}
		...
		[[nodiscard]] xieite::vec2<int> get_cursor() noexcept {
			...
			xieite::vec2<int> pos;
			std::fscanf(this->input, "\x1B[%i;%iR", &pos.x, &pos.y);
		...
		[[nodiscard]] constexpr std::string set_cursor_code(xieite::vec2<int> pos) noexcept {
			return "\x1B[" + xieite::num_str(pos.x + 1) + ";" + xieite::num_str(pos.y + 1) + "H";
		}

		void set_cursor(xieite::vec2<int> pos) noexcept {
			std::print(this->output, "{}", xieite::io_handle::set_cursor_code(pos));
		}

		[[nodiscard]] constexpr std::string move_cursor_code(xieite::vec2<int> diff) noexcept {
			std::string code;
			if (diff.x) {
				code += "\x1B[";
				code += xieite::num_str(xieite::abs(diff.x));
				code += "CD"[diff.x < 0];
			}
			if (diff.y) {
				code += "\x1B[";
				code += xieite::num_str(xieite::abs(diff.y));
				code += "BA"[diff.y < 0];
			}
			return code;
		}

		void move_cursor(xieite::vec2<int> diff) noexcept {
			std::print(this->output, "{}", xieite::io_handle::move_cursor_code(diff));
		}
		...
		void cursor_invis(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::cursor_invis_code(value));
		}
		...
		void cursor_block(bool blink = false) noexcept {
			std::print(this->output, "{}", xieite::io_handle::cursor_block_code(blink));
		}
		...
		void cursor_underscore(bool blink = false) noexcept {
			std::print(this->output, "{}", xieite::io_handle::cursor_underscore(blink));
		}
		...
		void cursor_pipe(bool blink = false) noexcept {
			std::print(this->output, "{}", xieite::io_handle::cursor_pipe_code(blink));
		}
		...
		void cursor_alt(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::cursor_alt_code(value));
		}
		...
		void screen_alt(bool value) noexcept {
			std::print(this->output, "{}", xieite::io_handle::screen_alt_code(value));
		}
		...
		void clear_screen() noexcept {
			std::print(this->output, "{}", xieite::io_handle::clear_screen_code());
		}
		...
		void clear_screen_until() noexcept {
			std::print(this->output, "{}", xieite::io_handle::clear_screen_until_code());
		}
		...
		void clear_screen_from() noexcept {
			std::print(this->output, "{}", xieite::io_handle::clear_screen_from_code());
		}
		...
		void clear_line() noexcept {
			std::print(this->output, "{}", xieite::io_handle::clear_line_code());
		}
		...
		void clear_line_until() noexcept {
			std::print(this->output, "{}", xieite::io_handle::clear_line_until_code());
		}
		...
		void clear_line_from() noexcept {
			std::print(this->output, "{}", xieite::io_handle::clear_line_from_code());
		}
		...
		xieite::keyboard read_key() noexcept {
			const xieite::scope_guard _ = xieite::scope_guard(
				[this, block_prev = this->block_enabled] -> void {
					this->blocking(block_prev);
				}
			);
