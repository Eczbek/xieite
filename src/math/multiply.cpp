...
export namespace xieite::math {
	...
	[[nodiscard]] constexpr xieite::math::Product<UnsignedIntegral> multiply(const UnsignedIntegral multiplier, const std::common_type_t<UnsignedIntegral> multiplicand) noexcept {
