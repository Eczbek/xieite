...
static_assert(xte::big_int(-123).abs() == 123);
static_assert(xte::big_int(1).pow(-2) == 1);
static_assert(xte::big_int(1).pow(-1) == 1);
static_assert(xte::big_int(1).pow(0) == 1);
static_assert(xte::big_int(1).pow(1) == 1);
static_assert(xte::big_int(1).pow(2) == 1);
static_assert(xte::big_int(-2).pow(1) == -2);
static_assert(xte::big_int(-1).pow(1) == -1);
static_assert(xte::big_int(0).pow(1) == 0);
static_assert(xte::big_int(2).pow(1) == 2);
static_assert(xte::big_int(-1).pow(-2) == 1);
static_assert(xte::big_int(-1).pow(-1) == -1);
static_assert(xte::big_int(-1).pow(0) == 1);
static_assert(xte::big_int(-1).pow(1) == -1);
static_assert(xte::big_int(-1).pow(2) == 1);
static_assert(xte::big_int(-2).pow(-2) == 0);
static_assert(xte::big_int(2).pow(-2) == 0);
static_assert(xte::big_int(-2).pow(-1) == 0);
static_assert(xte::big_int(2).pow(-1) == 0);
static_assert(xte::big_int(-2).pow(0) == 1);
static_assert(xte::big_int(0).pow(0) == 1);
static_assert(xte::big_int(1).pow(0) == 1);
static_assert(xte::big_int(2).pow(0) == 1);
static_assert(xte::big_int(0).pow(2) == 0);
static_assert(xte::big_int(10).pow(3) == 1000);
static_assert(xte::big_int(2).pow(4) == 16);
...
static_assert(xte::big_int(256).root(3) == 6);
static_assert(xte::big_int(256).root(4) == 4);
static_assert(xte::big_int(0).root(2) == 0);
static_assert(xte::big_int(256).log(2) == 8);
static_assert(xte::big_int(256).log(4) == 4);
static_assert(xte::big_int(9).log(3) == 2);
static_assert(xte::big_int(123).log(0) == 0);
static_assert(xte::big_int(-123).log(0) == 0);
static_assert(xte::big_int(5).log(5) == 1);
static_assert(xte::big_int(123).log(123) == 1);
static_assert(xte::big_int(5).log(6) == 0);
static_assert(xte::big_int(123).log(124) == 0);
static_assert(xte::big_int(23742983).log(53) == 4);
static_assert(xte::big_int(123456789).log(17) == 6);
