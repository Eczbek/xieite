...
static_assert(xte::div(std::numeric_limits<int>::max(), -1) == (std::numeric_limits<int>::min() + 1));
static_assert(xte::div(std::numeric_limits<int>::min(), -1, -1) == std::numeric_limits<int>::min());
