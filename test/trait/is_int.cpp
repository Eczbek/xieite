...
static_assert(not xte::is_int<char>);
static_assert(not xte::is_int<void>);
static_assert(not xte::is_int<int&>);
static_assert(not xte::is_int<int&&>);
static_assert(not xte::is_int<char***&&>);
static_assert(not xte::is_int<int(decltype([] {})::*)(...) const volatile && noexcept>);
